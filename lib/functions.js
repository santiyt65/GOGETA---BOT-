...
async function cargarPlugins() {
  try {
    const { adivinaCommand } = await import(`../plugins/adivina.js`);
    const { pptCommand } = await import(`../plugins/ppt.js`);
    const { tagCommand } = await import(`../plugins/tag.js`);
    const { ahorcadoCommand } = await import(`../plugins/ahorcado.js`);
    const { triviaCommand } = await import(`../plugins/trivia.js`);
    const { matematicaCommand } = await import(`../plugins/matematica.js`);
    const { pinterestCommand } = await import(`../plugins/pinterest.js`);
